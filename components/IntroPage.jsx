        ...
        <div>
            ...
            <div className="page-section">
                ...
                <div className="questions-grid">
                    <QuestionCard 
                        id="q1" color="blue" icon="â“" title="What" subtitle="is Elasticity?"
                    ...
                    />
                    <QuestionCard 
                        id="q2" color="green" icon="ðŸ’¡" title="Why" subtitle="do solids deform?"
                    ...
                    />
                    <QuestionCard 
                        id="q3" color="purple" icon="ðŸ‘¤" title="Who" subtitle="defined these laws?"
                    ...
                    />
                    <QuestionCard 
                        id="q4" color="yellow" icon="ðŸ“" title="Where" subtitle="are they applied?"
                    ...
                    />
                    <QuestionCard 
                        id="q5" color="red" icon="â°" title="When" subtitle="does a solid break?"
                    ...
                    />
                    <QuestionCard 
                        id="q6" color="pink" icon="âš™ï¸" title="How" subtitle="to calculate it?"
                ...
                <div className="ready-banner">
                    ...
                    <button className="btn-solid" onClick={onNext}>Terminology âž”</button>
                </div>
            </div>
        </div>
    );
...
const termsData = [
    { id: 't1', icon: 'ðŸŒ€', title: 'Elasticity', definition: 'The inherent property of a material body by virtue of which it tends to regain its original size and shape after the removal of deforming forces.', examples: ['A stretched rubber band returning to its original size.', 'A steel spring bouncing back.'], hint: 'Think: "Snapping back". Perfect elasticity is an idealization.' },
    { id: 't2', icon: 'ðŸ§±', title: 'Plasticity', definition: 'The property by which a material does not regain its original dimensions at all and acquires a permanent deformation when the deforming force is removed.', examples: ['Modeling clay or putty being molded.', 'Bending a paperclip until it stays bent.'], hint: 'Think: "Plastic surgery" - it changes shape permanently.' },
    { id: 't3', icon: 'âš¡', title: 'Stress', definition: 'The internal restoring force acting per unit area of a deformed body.', examples: ['Weight hanging from a wire creating tensile stress.', 'Submarine under water experiencing volume stress.'], hint: 'Formula: Ïƒ = F/A. Unit is Pascal (Pa).' },
    { id: 't4', icon: 'ðŸ“', title: 'Strain', definition: 'The ratio of the change in dimension of a body to its original dimension.', examples: ['A 1m wire stretching by 1mm (Strain = 0.001).', 'A balloon shrinking under pressure.'], hint: 'It has no units! It is a pure ratio.' },
    { id: 't5', icon: 'âš ï¸', title: 'Elastic Limit', definition: 'The maximum stress up to which a body completely recovers its original shape upon removal of the deforming force.', examples: ['Stretching a spring too far so it gets ruined.'], hint: 'Beyond this point, Hooke\'s law fails and permanent damage begins.' },
];

const lawsData = [
    { id: 'l1', icon: 'âš–ï¸', label: 'Law 1', title: "Hooke's Law", definition: "For small deformations, the stress and strain are directly proportional to each other. Stress âˆ Strain.", examples: ['Spring balances rely entirely on this principle.', 'The linear part of a stress-strain curve.'], hint: "Stress = E Ã— Strain. (Where E is the modulus of elasticity)" },
    { id: 'l2', icon: 'ðŸ—ï¸', label: 'Modulus 1', title: "Young's Modulus (Y)", definition: "The ratio of tensile (or compressive) stress to the longitudinal strain. Relevant for 1D stretching.", examples: ['Calculating how much a steel cable will stretch under an elevator.', 'Comparing stiffness of bones.'], hint: "Y = (F/A) / (Î”L/L). High Y = Stiff material." },
    { id: 'l3', icon: 'âœ‚ï¸', label: 'Modulus 2', title: "Shear Modulus (G)", definition: "The ratio of shearing stress to the corresponding shearing strain. Relevant for twisting or sliding forces.", examples: ['Twisting a metal cylinder (torsion).', 'A thick book being pushed sideways.'], hint: "Also known as the Modulus of Rigidity." },
    { id: 'l4', icon: 'ðŸŽˆ', label: 'Modulus 3', title: "Bulk Modulus (B)", definition: "The ratio of hydraulic (volume) stress to the corresponding volume strain. Relevant for all states of matter.", examples: ['Compressing water deep in the ocean.', 'Air compression in a sealed syringe.'], hint: "B = -P / (Î”V/V). The negative sign indicates volume decreases as pressure increases." },
];
...
const quizData = [
    ...
    { q: "What is the dimensional formula for Stress?", options: ["[M L Tâ»Â²]", "[M Lâ»Â¹ Tâ»Â²]", "[M LÂ² Tâ»Â²]", "Dimensionless"], answer: 1, explanation: "Stress = Force / Area. Force is [M L Tâ»Â²] and Area is [LÂ²]. Dividing them gives [M Lâ»Â¹ Tâ»Â²], same as pressure." },
