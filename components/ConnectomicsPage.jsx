    ...
    <div>
        ...
        <div className="page-section">
            ...
            <div className="web-grid">
                <div className="web-card card-blue">
                    <div className="web-tag tag-blue">⚡ Direct</div>
                    <div className="web-title">
                        <div>Laws of Motion (Ch.5)</div>
                        <div><span style={{color: '#94a3b8', marginRight: '0.25rem', fontSize: '0.85rem'}}>→</span> <span>Work, Energy & Power (Ch.6)</span></div>
                    </div>
                ...
                <div className="web-card card-green">
                    <div className="web-tag tag-green">🌍 Direct</div>
                    <div className="web-title">
                        <div>Laws of Motion (Ch.5)</div>
                        <div><span style={{color: '#94a3b8', marginRight: '0.25rem', fontSize: '0.85rem'}}>→</span> <span>Gravitation (Ch.8)</span></div>
                    </div>
                ...
                <div className="web-card card-purple">
                    <div className="web-tag tag-purple">🔄 Fundamental</div>
                    <div className="web-title">
                        <div>Laws of Motion (Ch.5)</div>
                        <div><span style={{color: '#94a3b8', marginRight: '0.25rem', fontSize: '0.85rem'}}>→</span> <span>Rotational Motion (Ch.7)</span></div>
                    </div>
                    <div className="web-desc">Torque is the rotational analogue of force. Newton's Second Law extends to rotation as τ = Iα.</div>
                </div>
                <div className="web-card card-yellow">
                    <div className="web-tag tag-yellow">🔁 Mirror</div>
                    <div className="web-title">
                        <div>Laws of Motion (Ch.5)</div>
                        <div><span style={{color: '#94a3b8', marginRight: '0.25rem', fontSize: '0.85rem'}}>→</span> <span>Oscillations (Ch.14)</span></div>
                    </div>
                    <div className="web-desc">Simple Harmonic Motion is derived directly from Newton's Second Law: the restoring force F = -kx gives a = -ω²x.</div>
                </div>
                <div className="web-card card-pink">
                    <div className="web-tag tag-pink">🌊 Indirect</div>
                    <div className="web-title">
                        <div>Laws of Motion (Ch.5)</div>
                        <div><span style={{color: '#94a3b8', marginRight: '0.25rem', fontSize: '0.85rem'}}>→</span> <span>Waves (Ch.15)</span></div>
                    </div>
        ...
        <div className="page-section">
            ...
            <div className="real-world-grid">
                <div className="rw-card">
                    ...
                    <p className="rw-desc">Seatbelts and airbags are designed using impulse-momentum theorem — they increase the time of collision to reduce the peak force on the body.</p>
                </div>
                <div className="rw-card">
        ...
        <div className="page-section">
            <div className="infinite-box">
                ...
                <p>Newton's Laws aren't just a chapter — they're the backbone of engineering, sports science, and space exploration. Every time a car brakes or a rocket launches, these laws are at work.</p>
